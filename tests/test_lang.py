...
class TestLocalisation(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        male_cat = Cat(gender="tom")
        female_cat = Cat(gender="molly")
        nonbinary_cat = Cat()
        nonbinary_cat.genderalign = "non-binary"
        mystery_cat = Cat(gender="potato")
        mystery_cat.genderalign = "potato"
        cls.cat_combos_two = {
            "male-tom": [[male_cat, male_cat], cls.pronouns["1"]],
            "male-molly": [[male_cat, female_cat], cls.pronouns["1"]],
            "male-nonbinary": [[male_cat, nonbinary_cat], cls.pronouns["1"]],
            "female-tom": [[female_cat, male_cat], cls.pronouns["1"]],
            "female-molly": [[female_cat, female_cat], cls.pronouns["2"]],
            "female-nonbinary": [[female_cat, nonbinary_cat], cls.pronouns["2"]],
            "nonbinary-tom": [[nonbinary_cat, male_cat], cls.pronouns["1"]],
            "nonbinary-molly": [[nonbinary_cat, female_cat], cls.pronouns["2"]],
