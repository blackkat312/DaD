...
class Cat:
    ...
    genemod_conditions = [
        "albinism", "ocular albinism", "flat nose", "manx syndrome", "rabbit gait", "fully hairless",
    ...
    def __init__(
        ...
        **kwargs
            ...
            if randint(1, game.config["genetics_config"]["intersex"]) == 1:
                ...
                if randint(1, 25) == 1:
                    if "Y" in self.genotype.sexgene:
                        ...
                        self.genotype.sex = "tom"
            elif self.genotype.sexgene != ["o", "o"] and self.genotype.sexgene != ["O", "o"] and self.genotype.sexgene != ["O", "O"] and self.genotype.sexgene != ["o", "Y"] and self.genotype.sexgene != ["O", "Y"]:
                self.genotype.sex = "intersex"
            else:
                if "Y" in self.genotype.sexgene:
                    self.genotype.sex = "tom"
        ...
        self.phenotype.PhenotypeOutput(gender=self.genotype.sex, sex=self.genotype.sex, pattern=self.genotype.white_pattern)
        ...
        if self.genotype.chimerageno:
            ...
            self.chimerapheno.PhenotypeOutput(gender=self.genotype.chimerageno.sex, sex=self.genotype.chimerageno.sex, pattern=self.genotype.chimerageno.white_pattern)
        ...
        if self.genotype.munch[1] == "Mk" or self.genotype.fold[1] == "Fd" or (self.genotype.manx[1] == "Ab" or self.genotype.manx[1] == "M") or ('NoDBE' not in self.genotype.pax3 and 'DBEalt' not in self.genotype.pax3) or self.genotype.sexgene == ["Y"]:
            self.dead = True
    ...
    def GenerateWhite(self, KIT, albino, KITgrade, vit, white_pattern, pax3):
        ...
        maingame_white = {
            ...
            'high': {
                ...
                '5': ['ONEEAR', 'LIGHTSONG', 'BLACKSTAR', 'PETAL', 'CHESTSPECK', 'HEARTTWO', 'BOOTS', 'SHOOTINGSTAR',
                      'EYESPOT', 'KROPKA']
            }
        }
        ...
        high5 = ['ONEEAR', 'LIGHTSONG', 'BLACKSTAR', 'PETAL', 'CHESTSPECK', 'HEARTTWO', 'BOOTS', 'SHOOTINGSTAR',
                 'EYESPOT', 'KROPKA']
        ...
        def clean_white(white_pattern):
            new_white_pattern = list(set(white_pattern))
            ...
            if KIT[0] == "wg":
                ...
                if(randint(1, 3) == 1):
                    ...
                    if randint(1, 4) == 1:
                        ...
                        if chosen_white_1 in low1 or high1:
                            kit_addition += 0.5
                        elif chosen_white_1 in low2 or high2:
                            kit_addition += 1.5
                        elif chosen_white_1 in low3 or high3:
                            kit_addition += 2.5
                        elif chosen_white_1 in low4 or high4:
                            kit_addition += 3.5
                    ...
                    if randint(1, 8) == 1:
                        ...
                        if chosen_white_2 in low1 or high1:
                            kit_addition += 0.5
                        elif chosen_white_2 in low2 or high2:
                            kit_addition += 1.5
                        elif chosen_white_2 in low3 or high3:
                            kit_addition += 2.5
                        elif chosen_white_2 in low4 or high4:
                            kit_addition += 3.5
                    ...
                    if randint(1, 12) == 1:
                        ...
                        if chosen_white_3 in low1 or high1:
                            kit_addition += 0.5
                        elif chosen_white_3 in low2 or high2:
                            kit_addition += 1.5
                        elif chosen_white_3 in low3 or high3:
                            kit_addition += 2.5
                        elif chosen_white_3 in low4 or high4:
                            kit_addition += 3.5
                    ...
                    if randint(1, 16) == 1:
                        ...
                        if chosen_white_4 in low1 or high1:
                            kit_addition += 0.5
                        elif chosen_white_4 in low2 or high2:
                            kit_addition += 1.5
                        elif chosen_white_4 in low3 or high3:
                            kit_addition += 2.5
                        elif chosen_white_4 in low4 or high4:
                            kit_addition += 3.5
                    ...
                    if randint(1, 20) == 1:
                        ...
                        if chosen_white_5 in low1 or high1:
                            kit_addition += 0.5
                        elif chosen_white_5 in low2 or high2:
                            kit_addition += 1.5
                        elif chosen_white_5 in low3 or high3:
                            kit_addition += 2.5
                        elif chosen_white_5 in low4 or high4:
                            kit_addition += 3.5
                    ...
                    while len(white_pattern) < 4:
                        ...
                        white_pattern.append(choice(['belt', 'belt', 'pants', None, None, None, None, None, None, None, None, None]))
                    ...
                    while len(white_pattern) < 4:
                        ...
                        white_pattern.append(choice(['belt', 'belt', 'pants', None, None, None, None, None]))
                        ...
                        for i in range(randint(0, 2)):
                            white_pattern.append(choice(['break/bracelet left', 'break/bracelet right', None, None, None, None, None]))
                    ...
                    while len(white_pattern) < 4:
                        ...
                        white_pattern.append(choice(['belt', 'belt', 'pants', None, None, None]))
    ...
    def aneuploidy_type(self):
        ...
        if (self.genotype.sexgene != ["o", "o"] and self.genotype.sexgene != ["O", "o"] and self.genotype.sexgene != ["O", "O"] and self.genotype.sexgene != ["o", "Y"] and self.genotype.sexgene != ["O", "Y"]) or (self.genotype.chimera and self.genotype.chimerageno.sexgene != ["o", "o"] and self.genotype.chimerageno.sexgene != ["O", "o"] and self.genotype.chimerageno.sexgene != ["O", "O"] and self.genotype.chimerageno.sexgene != ["o", "Y"] and self.genotype.chimerageno.sexgene != ["O", "Y"]):
            ...
            if self.genotype.sexgene == ["o"] or self.genotype.sexgene == ["O"] or (self.genotype.chimera and (self.genotype.chimerageno.sexgene == ["o"] or self.genotype.chimerageno.sexgene == ["O"])):
                turner = True

            if self.genotype.sexgene == ["o", "o", "Y"] or self.genotype.sexgene == ["O", "o", "Y"] or self.genotype.sexgene == ["O", "O", "Y"] or (self.genotype.chimera and (self.genotype.chimerageno.sexgene == ["o", "o", "Y"] or self.genotype.chimerageno.sexgene == ["O", "o", "Y"] or self.genotype.chimerageno.sexgene == ["O", "O", "Y"])):
                xxy = True

            if self.genotype.sexgene == ["o", "o", "o"] or self.genotype.sexgene == ["O", "o", "o"] or self.genotype.sexgene == ["O", "O", "o"] or self.genotype.sexgene == ["O", "O", "O"] or (self.genotype.chimera and (self.genotype.chimerageno.sexgene == ["o", "o", "o"] or self.genotype.chimerageno.sexgene == ["O", "o", "o"] or self.genotype.chimerageno.sexgene == ["O", "O", "o"] or self.genotype.chimerageno.sexgene == ["O", "O", "O"])):
                xxx = True

            if self.genotype.sexgene == ["o", "Y", "Y"] or self.genotype.sexgene == ["O", "Y", "Y"] or (self.genotype.chimera and (self.genotype.chimerageno.sexgene == ["o", "Y", "Y"] or self.genotype.chimerageno.sexgene == ["O", "Y", "Y"])):
                xyy = True

            return [aneuploidy, turner, xxy, xxx, xyy]
        else:
            return [False, False, False, False, False]

    def genetic_conditions(self):
        aneuploidy_type = self.aneuploidy_type()

        aneuploidy = aneuploidy_type[0]
        turner = aneuploidy_type[1]
        xxy = aneuploidy_type[2]
        xxx = aneuploidy_type[3]
        xyy = aneuploidy_type[4]

        turner_list = [
            choice([
                "weak leg", "twisted leg", "partial hearing loss", "partial hearing loss in one ear",
                "deaf in one ear", "constant joint pain", "allergies"
            ]),
            choice([
                "weak leg", "twisted leg", "partial hearing loss", "partial hearing loss in one ear",
                "deaf in one ear", "constant joint pain", "allergies"
            ...
            choice([
                "born without a leg", "born without a leg", "paralyzed", "bad back", "bad back", "narrowed chest",
                "narrowed chest", "seizure prone"
            ])
        ]

        klinefelter_list = [
            choice([
                "weak leg", "twisted leg", "constant joint pain", "allergies"
            ]),
            choice([
                "weak leg", "twisted leg", "constant joint pain", "allergies"
            ]),
            ...
            choice([
                "born without a leg", "bad back", "narrowed chest", "seizure prone"
            ])
        ]

        four_list = [
            choice([
                "weak leg", "twisted leg", "bad back", "constant joint pain", "allergies"
            ]),
            choice([
                "weak leg", "twisted leg", "bad back", "constant joint pain", "allergies"
            ]),
            ...
            choice([
                "born without a leg", "paralyzed", "narrowed chest", "seizure prone", "seizure prone"
            ]),
            choice([
                "born without a leg", "paralyzed", "narrowed chest", "seizure prone", "seizure prone"
            ])
        ...
        if "intersex" not in self.conditions_already_attempted:
            if self.genotype.sex == "intersex":
                ...
                if num == 0:
                    if randint(1, 15) == 1:
                        self.get_permanent_condition("sterility", born_with=True, genetic=True)

                # Cats with aneuploidy
                if "sterility" not in self.permanent_condition:
                    if aneuploidy:
                        if xyy:
                            num = 6
                        elif xxx:
                ...
                # Chimeras
                if self.genotype.chimera:
                    if self.genderalign in ["molly", "tom"]:
                    ...
                    self.conditions_already_attempted.append("intersex")
                    self._pronouns = None
                    self._pronouns = {i18n.config.get("locale"): self.pronouns}

                # XY mollies and XX toms
                if ("Y" in self.genotype.sexgene and self.genotype.sex == "molly") or ("Y" not in self.genotype.sexgene and self.genotype.sex == "tom"):
                    self.get_permanent_condition("sterility", born_with=True, genetic=True)
                    self.conditions_already_attempted.append("intersex")
        ...
        if "aneuploidy" not in self.conditions_already_attempted:
            if aneuploidy:
                if turner:
                    ...
                    if randint(1, 50) != 1:
                        self.get_permanent_condition("wasting disease", born_with=True, genetic=True)

                    if randint(1, 20) <= 6 and not self.genotype.vitiligo:
                        counter += 1

                        has_vitiligo = []
                        if self.genotype.white_pattern is not None and self.genotype.white_pattern != "No":
                            has_vitiligo = [patch for patch in self.genotype.white_pattern if patch in Pelt.vit]

                        if self.genotype.white_pattern is None or self.genotype.white_pattern == "No":
                            self.genotype.white_pattern = [choice(Pelt.vit)]
                        else:
                            if len(has_vitiligo) == 0:
                                self.genotype.white_pattern.append(choice(Pelt.vit))
                    ...
                    if randint(1, 20) <= 13:
                        ...
                        if not skip:
                            ...
                            self.get_permanent_condition(chosen, born_with=True, genetic=True)
                    ...
                    if randint(1, 7) == 1 and not counter >= 3:
                        chosen = choice(turner_list)
                ...
                elif len(self.genotype.sexgene) == 3 or (self.genotype.chimera and len(self.genotype.chimerageno.sexgene) == 3):
                    if xxy:  # klinefelter
                        counter = 0
                        ...
                        if randint(1, 7) == 1 and counter != 3:
                            chosen = choice(klinefelter_list)
                ...
                elif len(self.genotype.sexgene) >= 4 or (self.genotype.chimera and len(self.genotype.chimerageno.sexgene) >= 4):
                    counter = 0
        ...
        if 'manx syndrome' in self.permanent_condition:
            ...
            if "incontinence" not in self.conditions_already_attempted:
                ...
                self.conditions_already_attempted.append("incontinence")
            ...
            if "bad back" not in self.conditions_already_attempted:
                ...
                self.conditions_already_attempted.append("bad back")
        ...
        if "ocular albinism" not in self.conditions_already_attempted and "albinism" not in self.conditions_already_attempted:
            if (
                    ...
                    or (self.genotype.somatic and self.genotype.somatic != "{}" and "face" in self.genotype.somatic["base"] and (self.genotype.somatic["allele"] == "c" or self.genotype.somatic["allele"] == "dp"))
                    or (self.genotype.chimera and self.genotype.chimerageno.somatic and self.genotype.chimerageno.somatic != "{}" and "face" in self.genotype.chimerageno.somatic["base"] and (self.genotype.chimerageno.somatic["allele"] == "c" or self.genotype.chimerageno.somatic["allele"] == "dp"))
            ):
    ...
    def one_moon(self):
        ...
        if self.gender != self.genotype.sex:
            self.gender = self.genotype.sex
            print(f"{self.name}'s gender doesn't match their genotype.sex. Resetting...")
    ...
    def congenital_condition(self, cat):
        ...
        comorbid_conditions = {
            ...
            "bad back": [
                "paralyzed", "constant joint pain", "seizure prone"
            ]
        }

        for condition in PERMANENT:
            possible = PERMANENT[condition]
            if possible["congenital"] in ['always', 'sometimes'] and condition not in self.genemod_conditions and condition != "born without a tail":
    ...
    def get_permanent_condition(self, name, born_with=False, event_triggered=False, starting_moon=0, genetic=False, custom_reveal=None):
        ...
        if not genetic and name in self.genemod_conditions:
            return

        if name in ["one bad eye", "failing eyesight", "failing eyesight in one eye"] and "blind" in self.permanent_condition:
            return
        if name == "failing eyesight in one eye" and "failing eyesight" in self.permanent_condition:
            return
        if name == "failing eyesight in one eye" and "one bad eye" in self.permanent_condition:
            return

        if name in ["partial hearing loss", "partial hearing loss in one ear", "deaf in one ear"] and "deaf" in self.permanent_condition:
            return
        if name == "partial hearing loss in one ear" and "partial hearing loss" in self.permanent_condition:
            return
        if name == "partial hearing loss in one ear" and "deaf in one ear" in self.permanent_condition:
            return
    ...
    def is_potential_mate(
        ...
        if (self.age in age_restricted_ages or other_cat.age in age_restricted_ages) and self.age != other_cat.age:
            return False
    ...
    def get_save_dict(self, faded=False):
        if faded:
            ...
            return {
                ...
                "conditions_already_attempted": self.conditions_already_attempted or [],
...
def create_cat(status, moons=None, biome=None, kittypet=False):
    ...
    scar_to_condition = {
        "THREE": ["one bad eye", "failing eyesight in one eye"],
        "FOUR": ["weak leg", "weak leg", "no", "no", "no"],
        "NOLEFTEAR": ["partial hearing loss in one ear", "partial hearing loss in one ear", "deaf in one ear"],
        "NORIGHTEAR": ["partial hearing loss in one ear", "partial hearing loss in one ear", "deaf in one ear"],
        ...
        "LEFTBLIND": ["one bad eye", "failing eyesight in one eye"],
        "RIGHTBLIND": ["one bad eye", "failing eyesight in one eye"],
        "BOTHBLIND": ["blind", "failing eyesight"],
        "MANLEG": ["weak leg", "twisted leg"],
        "RATBITE": ["weak leg", "weak leg", "no", "no", "no"],
        "LEGBITE": ["weak leg", "weak leg", "no", "no", "no"],
        "TOETRAP": ["weak leg", "weak leg", "no", "no", "no"],
        "HINDLEG": ["weak leg", "weak leg", "no", "no", "no"],
    }
