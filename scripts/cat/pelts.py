...
class Pelt:
    ...
    tortiepatterns = [
        ...
        'SKULL', 'BODY', 'SHILOH', 'TABBY', 'SPECKLED', 'BENGAL', 'CLASSIC', 'MACKEREL', 'MARBLED',
        ...
        # mink's
        'MINKLITTLE', 'MINKLIGHTTUXEDO', 'MINKBUZZARDFANG', 'MINKTIP', 'MINKBIB',
        'MINKBELLY', 'MINKBROKENBLAZE', 'MINKLILTWO',
        'MINKRAVENPAW', 'MINKHONEY', 'MINKEXTRA', 'MINKMUSTACHE', 'MINKREVERSEHEART', 'MINKSPARKLE',
        ...
        'MINKOWL', 'MINKBUB', 'MINKSPARROW', 'MINKTRIXIE', 'MINKSAMMY', 'MINKFRONT', 'MINKBLOSSOMSTEP',
        'MINKCOWTWO', 'MINKCOWFOUR', 'MINKCOWSIX', 'MINKCOWEIGHT', 'MINKCOWELEVEN', 'MINKFINN', 'MINKSCAR',
        'MINKBUSTER', 'MINKCAKE', 'MINKVAN', 'MINKONEEAR', 'MINKLIGHTSONG', 'MINKTAIL', 'MINKHEART',
    ...
    """
    tortiepatterns = [
        '', 'MINKTWO', 'MINKTHREE', 'MINKFOUR', 'MINKREDTAIL', 'MINKDELILAH', 'MINKHALF', 'MINKSTREAK', 'MINKMASK', 'MINKSMOKE', 'MINKMINIMALONE',
        ...
        'MINKMAXIMUMSIX', 'MINKMAXIMUMSEVEN', 'MINKMAXIMUMEIGHT', 'MINKFRECKLED', 'MINKHEARTBEAT',
    """
    ...
    high_white = ['ANY', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO',
                  ...
                  'CURVED', 'MAO', 'PAINTED', 'NIGHTMIST', 'FALCON', 'RETSUKO',
                  'SNOWSTORM', 'OWL', 'BUB', 'SPARROW', 'TRIXIE',
