...
class Pelt:
    ...
    tortiepatterns = [
        ...
        'MINKMASKMANTLE', 'MINKMAO', 'MINKPAINTED', 'MINKNIGHTMIST', 'MINKFALCON', 'MINKRETSUKO', 'MINKSHIBAINU',
        'MINKSNOWSTORM', 'MINKPEPPER', 'MINKOWL', 'MINKBUB', 'MINKSPARROW', 'MINKTRIXIE', 'MINKSAMMY', 'MINKFRONT',
        'MINKBLOSSOMSTEP', 'MINKFINN', 'MINKSCAR', 'MINKBUSTER', 'MINKCAKE', 'MINKVAN', 'MINKLIGHTSONG', 'MINKTAIL',
        'MINKHEART', 'MINKMOORISH', 'MINKAPRON', 'MINKCAPSADDLE', 'MINKMOTH', 'MINKFRECKLEMASK', 'MINKCOW', 'MINKTIDAL',
    ...
    high_white = [
        ...
        # mink's
        'MINKONE', 'MINKDELILAH', 'MINKHALF', 'MINKMINIMALFOUR', 'MINKOREO', 'MINKSWOOP', 'MINKARMTAIL', 'MINKMOTTLED',
        'MINKSTREAMSTRIKE', 'MINKDAUB', 'MINKBRINDLE', 'MINKPAIGE', 'MINKTABBY', 'MINKSPECKLED', 'MINKBENGAL',
        'MINKCLASSIC', 'MINKMACKEREL', 'MINKMARBLED', 'MINKSABER', 'MINKROSETTE', 'MINKMASKED', 'MINKDUST',
        'MINKMAXIMUMSIX', 'MINKMAXIMUMSEVEN', 'MINKMAXIMUMEIGHT', 'MINKFRECKLED'
    ]
