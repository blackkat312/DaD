...
class Pelt:
    ...
    tortiepatterns = [
        ...
        "MINKBUB", "MINKBOWTIE", "MINKREVERSEHEART", "MINKSPARROW", "MINKVEST", "MINKLOVEBUG", "MINKSAMMY",
        "MINKSHOOTINGSTAR", "MINKREVERSEEYE", "MINKFRONT", "MINKBLOSSOMSTEP", "MINKPEBBLE", "MINKTAILTWO", "MINKBUDDY",
        "MINKFINN", "MINKDIGIT", "MINKKROPKA", "MINKFCONE", "MINKMIA", "MINKSCAR", "MINKBUSTER", "MINKCAKE",
