...
class Pelt:
    ...
    tortiepatterns = [
        ...
        'SKULL', 'POINTS', 'DITTO', 'BODY', 'SHILOH', 'TABBY', 'SPECKLED', 'BENGAL', 'CLASSIC', 'MACKEREL', 'MARBLED',
        ...
        'MINKSQUEAKS', 'MINKSTAR', 'MINKWINGS', 'MINKMOSSY', 'MINKCHANCE', 'MINKDIVA', 'MINKSAVANNAH', 'MINKFADESPOTS',
        'MINKBEARD', 'MINKDAPPLEPAW', 'MINKTOPCOVER', 'MINKWOODPECKER', 'MINKMISS', 'MINKVENUS', 'MINKBOWTIE',
        'MINKVEST', 'MINKFADEBELLY', 'MINKDIGIT', 'MINKFCTWO', 'MINKFCONE', 'MINKMIA', 'MINKROSINA', 'MINKPRINCESS',
        'MINKDOUGIE', 'MINKANY', 'MINKANYTWO', 'MINKBROKEN', 'MINKFRECKLES', 'MINKRINGTAIL', 'MINKHALFFACE',
        'MINKPANTSTWO', 'MINKGOATEE', 'MINKPRINCE', 'MINKFAROFA', 'MINKMISTER', 'MINKPANTS', 'MINKREVERSEPANTS',
        'MINKHALFWHITE', 'MINKAPPALOOSA', 'MINKPIEBALD', 'MINKCURVED', 'MINKGLASS', 'MINKMASKMANTLE', 'MINKMAO',
        'MINKPAINTED', 'MINKNIGHTMIST', 'MINKFALCON', 'MINKRETSUKO', 'MINKSHIBAINU', 'MINKSNOWSTORM', 'MINKPEPPER',
        'MINKOWL', 'MINKBUB', 'MINKSPARROW', 'MINKTRIXIE', 'MINKSAMMY', 'MINKFRONT', 'MINKBLOSSOMSTEP', 'MINKBULLSEYE',
        'MINKCOWTWO', 'MINKCOWFOUR', 'MINKCOWSIX', 'MINKCOWEIGHT', 'MINKCOWELEVEN', 'MINKFINN', 'MINKSCAR',
        'MINKBUSTER', 'MINKHAWKBLAZE', 'MINKCAKE', 'MINKVAN', 'MINKONEEAR', 'MINKLIGHTSONG', 'MINKTAIL', 'MINKHEART',
        'MINKMOORISH', 'MINKAPRON', 'MINKCAPSADDLE', 'MINKCHESTSPECK', 'MINKBLACKSTAR', 'MINKPETAL', 'MINKHEARTTWO',
        'MINKMOTH', 'MINKFRECKLEMASK', 'MINKCOW', 'MINKTIDAL', 'MINKDIAMOND', 'MINKECLIPSE', 'MINKPEBBLESHINE',
        'MINKBOOTS', 'MINKCOWTHREE', 'MINKCOWFIVE', 'MINKCOWSEVEN', 'MINKCOWNINE', 'MINKCOWTEN', 'MINKLOVEBUG',
        'MINKSHOOTINGSTAR', 'MINKEYESPOT', 'MINKPEBBLE', 'MINKTAILTWO', 'MINKBUDDY', 'MINKBATWING', 'MINKKROPKA',
        'MINKSMALLPATCHES', 'MINKCOLOURPOINT', 'MINKRAGDOLL', 'MINKSEPIAPOINT', 'MINKMINKPOINT', 'MINKSEALPOINT',
        'MINKVITILIGO', 'MINKVITILIGOTWO', 'MINKMOON', 'MINKPHANTOM', 'MINKKARPATI', 'MINKPOWDER', 'MINKSPLAT',
        'MINKBLEACHED', 'MINKSMOKEY'
    ]
    ...
    """
    tortiepatterns = [
        'MINKONE', 'MINKTWO', 'MINKTHREE', 'MINKFOUR', 'MINKREDTAIL', 'MINKDELILAH', 'MINKHALF', 'MINKSTREAK', 'MINKMASK', 'MINKSMOKE', 'MINKMINIMALONE',
        'MINKMINIMALTWO', 'MINKMINIMALTHREE', 'MINKMINIMALFOUR', 'MINKOREO', 'MINKSWOOP', 'MINKCHIMERA', 'MINKCHEST', 'MINKARMTAIL', 'MINKGRUMPYFACE',
        'MINKMOTTLED', 'MINKSIDEMASK', 'MINKEYEDOT', 'MINKBANDANA', 'MINKPACMAN', 'MINKSTREAMSTRIKE', 'MINKSMUDGED', 'MINKDAUB', 'MINKEMBER', 'MINKBRIE',
        'MINKORIOLE', 'MINKROBIN', 'MINKBRINDLE', 'MINKPAIGE', 'MINKROSETAIL', 'MINKSAFI', 'MINKDAPPLENIGHT', 'MINKBLANKET', 'MINKBELOVED', 'MINKVIPER',
        'MINKSKULL', 'MINKPOINTS', 'MINKDITTO', 'MINKBODY', 'MINKSHILOH', 'MINKTABBY', 'MINKSPECKLED', 'MINKBENGAL', 'MINKCLASSIC', 'MINKMACKEREL', 'MINKMARBLED',
        'MINKSABER', 'MINKROSETTE', 'MINKMASKED', 'MINKDUST', 'MINKMAXIMUMONE', 'MINKMAXIMUMTWO', 'MINKMAXIMUMTHREE', 'MINKMAXIMUMFOUR', 'MINKMAXIMUMFIVE',
        'MINKMAXIMUMSIX', 'MINKMAXIMUMSEVEN', 'MINKMAXIMUMEIGHT',
        
    tortiepatterns = [
        'MINKONE', '', '', 'MINKFOUR', '', 'MINKDELILAH', 'MINKHALF', 'MINKSTREAK', '', '', '',
        '', '', 'MINKMINIMALFOUR', 'MINKOREO', 'MINKSWOOP', 'MINKCHIMERA', '', 'MINKARMTAIL', '',
        'MINKMOTTLED', '', '', '', '', 'MINKSTREAMSTRIKE', '', '', '', '',
        '', '', 'MINKBRINDLE', 'MINKPAIGE', '', 'MINKSAFI', '', '', '', '',
        '', 'MINKPOINTS', 'MINKDITTO', 'MINKBODY', 'MINKSHILOH', 'MINKTABBY', 'MINKSPECKLED', 'MINKBENGAL', 'MINKCLASSIC', 'MINKMACKEREL', 'MINKMARBLED',
        'MINKSABER', 'MINKROSETTE', 'MINKMASKED', 'MINKDUST', 'MINKMAXIMUMONE', 'MINKMAXIMUMTWO', 'MINKMAXIMUMTHREE', 'MINKMAXIMUMFOUR', 'MINKMAXIMUMFIVE',
        'MINKMAXIMUMSIX', 'MINKMAXIMUMSEVEN', 'MINKMAXIMUMEIGHT',
    """
    ...
    little_white = ['LITTLE', 'LIGHTTUXEDO', 'BUZZARDFANG', 'TIP', 'BLAZE', 'BIB', 'VEE', 'PAWS',
                    ...
                    # mink's
                    'MINKREDTAIL', 'MINKMINIMALTHREE', 'MINKCHEST', 'MINKMASK', 'MINKSMOKE', 'MINKMINIMALONE',
                    'MINKMINIMALTWO', 'MINKBANDANA', 'MINKPACMAN', 'MINKROSETAIL', 'MINKSMUDGED', 'MINKEMBER',
                    'MINKORIOLE', 'MINKSKULL']
    ...
    mid_white = ['TUXEDO', 'FANCY', 'UNDERS', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR',
                 ...
                 # mink's
                 'MINKTWO', 'MINKTHREE', 'MINKGRUMPYFACE', 'MINKDAUB', 'MINKBRIE', 'MINKROBIN', 'MINKSIDEMASK',
                 'MINKEYEDOT', 'MINKDAPPLENIGHT', 'MINKBLANKET', 'MINKBELOVED', 'MINKVIPER']
