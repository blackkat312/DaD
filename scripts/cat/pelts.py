...
class Pelt:
    ...
    tortiepatterns = [
        ...
        "MINKLIGHTTUXEDO", "MINKLIGHTSONG", "MINKBLACKSTAR", "MINKPIEBALD", "MINKCURVED", "MINKPETAL", "MINKSHIBAINU",
        "MINKOWL", "MINKTIP", "MINKFANCY", "MINKFRECKLES", "MINKRINGTAIL", "MINKHALFFACE", "MINKPANTSTWO", "MINKGOATEE",
        "MINKMITAINE", "MINKBROKENBLAZE", "MINKTAIL", "MINKPRINCE", "MINKUNDERS", "MINKFAROFA", "MINKMISTER",
        "MINKTOPCOVER", "MINKAPRON", "MINKCAPSADDLE", "MINKMASKMANTLE", "MINKSQUEAKS", "MINKSTAR", "MINKSKUNK",
        "MINKHALFWHITE", "MINKAPPALOOSA", "MINKDAPPLEPAW", "MINKHEART", "MINKLILTWO", "MINKGLASS", "MINKMOORISH",
        "MINKMAO", "MINKWINGS", "MINKHEARTTWO", "MINKWOODPECKER", "MINKBOOTS", "MINKMISS", "MINKCOW", "MINKCOWTWO",
        "MINKBUB", "MINKBOWTIE", "MINKREVERSEHEART", "MINKSPARROW", "MINKVEST", "MINKLOVEBUG", "MINKTRIXIE",
        "MINKSAMMY", "MINKSHOOTINGSTAR", "MINKREVERSEEYE", "MINKFRONT", "MINKBLOSSOMSTEP", "MINKPEBBLE", "MINKTAILTWO",
        "MINKBUDDY", "MINKFINN", "MINKDIGIT", "MINKKROPKA", "MINKFCONE", "MINKMIA", "MINKSCAR",
        "MINKBUSTER", "MINKCAKE", "MINKPRINCESS", "MINKDOUGIE", "MINKEXTRA"
    ]
    tortiebases = [
        "single",
        "tabby",
    ...
    little_white = [
        ...
        "BLAZEMASK",
        "TEARS",
        "MINKMINIMALONE", "MINKMINIMALTWO", "MINKMINIMALTHREE",
    ...
    def init_accessories(self, age):
        ...
        if self.phenotype.bobtailnr > 0 and self.phenotype.bobtailnr < 5 and self.accessory in ['RED FEATHERS', 'BLUE FEATHERS', 'JAY FEATHERS', 'GULL FEATHERS', 'SPARROW FEATHERS', 'CLOVER', 'DAISY']:
            self.accessory = None
