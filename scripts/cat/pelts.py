...
class Pelt:
    ...
    tortiepatterns = [
        'ONE', 'TWO', 'THREE', 'FOUR', 'REDTAIL', 'DELILAH', 'HALF', 'STREAK', 'MASK', 'SMOKE', 'MINIMALONE',
        'MINIMALTWO', 'MINIMALTHREE', 'MINIMALFOUR', 'OREO', 'SWOOP', 'CHIMERA', 'CHEST', 'ARMTAIL', 'GRUMPYFACE',
        'MOTTLED', 'SIDEMASK', 'EYEDOT', 'BANDANA', 'PACMAN', 'STREAMSTRIKE', 'SMUDGED', 'DAUB', 'EMBER', 'BRIE',
        'ORIOLE', 'ROBIN', 'BRINDLE', 'PAIGE', 'ROSETAIL', 'SAFI', 'DAPPLENIGHT', 'BLANKET', 'BELOVED', 'VIPER',
        'SKULL', 'BODY', 'SHILOH', 'TABBY', 'SPECKLED', 'BENGAL', 'CLASSIC', 'MACKEREL', 'MARBLED', 'SABER', 'ROSETTE',
        'MASKED', 'DUST', 'MAXIMUMONE', 'MAXIMUMTWO', 'MAXIMUMTHREE', 'MAXIMUMFOUR', 'MAXIMUMFIVE', 'MAXIMUMSIX',
        'MAXIMUMSEVEN', 'MAXIMUMEIGHT', 'FRECKLED', 'HEARTBEAT',

        # mink's
        'MINKLITTLE', 'MINKLIGHTTUXEDO', 'MINKBUZZARDFANG', 'MINKTIP', 'MINKBROKENBLAZE', 'MINKLILTWO', 'MINKTUXEDO',
        'MINKFANCY', 'MINKUNDERS', 'MINKDAMIEN', 'MINKSKUNK', 'MINKMITAINE', 'MINKSQUEAKS', 'MINKSTAR', 'MINKWINGS',
        'MINKMOSSY', 'MINKCHANCE', 'MINKDIVA', 'MINKSAVANNAH', 'MINKFADESPOTS', 'MINKDAPPLEPAW', 'MINKTOPCOVER',
        'MINKWOODPECKER', 'MINKMISS', 'MINKVENUS', 'MINKBOWTIE', 'MINKVEST', 'MINKDIGIT', 'MINKFCTWO', 'MINKFCONE',
        'MINKMIA', 'MINKROSINA', 'MINKPRINCESS', 'MINKDOUGIE', 'MINKANY', 'MINKANYTWO', 'MINKBROKEN', 'MINKFRECKLES',
        'MINKRINGTAIL', 'MINKHALFFACE', 'MINKPANTSTWO', 'MINKGOATEE', 'MINKPRINCE', 'MINKFAROFA', 'MINKMISTER',
        'MINKPANTS', 'MINKREVERSEPANTS', 'MINKHALFWHITE', 'MINKAPPALOOSA', 'MINKPIEBALD', 'MINKCURVED', 'MINKGLASS',
        'MINKMASKMANTLE', 'MINKMAO', 'MINKPAINTED', 'MINKNIGHTMIST', 'MINKFALCON', 'MINKSHIBAINU', 'MINKSNOWSTORM',
        'MINKPEPPER', 'MINKOWL', 'MINKBUB', 'MINKSPARROW', 'MINKTRIXIE', 'MINKSAMMY', 'MINKFRONT', 'MINKBLOSSOMSTEP',
        'MINKFINN', 'MINKSCAR', 'MINKBUSTER', 'MINKCAKE', 'MINKVAN', 'MINKLIGHTSONG', 'MINKTAIL', 'MINKHEART',
        'MINKMOORISH', 'MINKAPRON', 'MINKCAPSADDLE', 'MINKMOTH', 'MINKFRECKLEMASK', 'MINKCOW', 'MINKTIDAL',
        'MINKDIAMOND', 'MINKECLIPSE', 'MINKPEBBLESHINE', 'MINKBOOTS', 'MINKCOWTHREE', 'MINKCOWFIVE', 'MINKCOWSEVEN',
        'MINKCOWNINE', 'MINKCOWTEN', 'MINKLOVEBUG', 'MINKPEBBLE', 'MINKTAILTWO', 'MINKBUDDY', 'MINKBATWING',
        'MINKKROPKA', 'MINKSMALLPATCHES'
    ]
    ...
    # missing parts
    scars2 = ["LEFTEAR", "RIGHTEAR", "NOTAIL", "HALFTAIL", "NOPAW", "NOLEFTEAR", "NORIGHTEAR", "NOEAR", "TIPPED"]
    ...
    simple_acc = ["MAPLE LEAF", "HOLLY", "BLUE BERRIES", "FORGET ME NOTS", "RYE STALK", "CATTAIL", "BLUEBELLS",
                  ...
                  "BALL", "MOUSE", "BONE", "MOSSBLANKIE", "AUTISMFLAG", "DISFLAG", "ZEBFLAG"]
    ...
    single_colours = [
        ...
        'YELLOW', 'GOLD', 'BRONZE', 'PALE FIRE', 'FIRE', 'DARK FIRE', 'GINGER', 'DARK GINGER', 'DARK ORANGE',
        'PALE BROWN', 'ALMOND', 'BIRCH', 'PALE LAVENDER', 'LAVENDER', 'DARK LAVENDER', 'PALE CINNAMON', 'CINNAMON', 'SABLE',
        'DARK SABLE', 'ACORN', 'LIGHT BROWN', 'BROWN', 'DARK BROWN', 'COFFEE', 'PALE EMBER', 'EMBER', 'SANDY',
        'COCOA', 'WARM HONEY', 'CHOCOLATE', 'SIENNA', 'GRANITE', 'BLUE GRAY', 'SANDSTONE'
    ]
    white_colours = ['WHITE', 'SNOW WHITE']
    blue_colours = ['PALE BLUE', 'BLUE', 'PALE LILAC', 'LILAC', 'BLUE GRAY']
    gray_colours = ['GRAY', 'SLATE', 'DARK GRAY', 'DARK SLATE', 'GRANITE']
    black_colours = ['BLACK', 'SOOT BLACK', 'OBSIDIAN', 'GHOST', 'SILVER']
    cream_colours = ['LIGHT CREAM', 'CREAM', 'DARK CREAM', 'PALE GOLD', 'PALE GINGER', 'ROSE', 'SIENNA', 'SANDY', 'PALE EMBER']
    gold_colours = ['YELLOW', 'GOLD', 'BRONZE']
    fire_colours = ['PALE FIRE', 'FIRE', 'DARK FIRE', 'WARM HONEY']
    ginger_colours = ['GINGER', 'DARK GINGER', 'DARK ORANGE', 'EMBER']
    ...
    little_white = [
        ...
        # mink's
        'MINKMASK', 'MINKSMOKE', 'MINKMINIMALONE', 'MINKMINIMALTWO', 'MINKMINIMALTHREE', 'MINKCHEST', 'MINKPACMAN',
        'MINKSMUDGED', 'MINKEMBER', 'MINKROBIN', 'MINKROSETAIL', 'MINKDAPPLENIGHT', 'MINKSKULL'
    ]

    mid_white = [
        'TUXEDO', 'FANCY', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR', 'DIVA', 'SAVANNAH', 'FADESPOTS',
        'DAPPLEPAW', 'TOPCOVER', 'WOODPECKER', 'MISS', 'BOWTIE', 'VEST', 'FADEBELLY', 'DIGIT', 'FCTWO', 'FCONE', 'MIA',
        'ROSINA', 'PRINCESS',

        'APPALOOSA', 'SHIBAINU', 'COWTWO', 'COWFOUR', 'COWSIX', 'COWEIGHT',

        # mink's
        'MINKTWO', 'MINKTHREE', 'MINKFOUR', 'MINKREDTAIL', 'MINKSTREAK', 'MINKCHIMERA', 'MINKGRUMPYFACE',
        'MINKSIDEMASK', 'MINKEYEDOT', 'MINKBRIE', 'MINKORIOLE', 'MINKSAFI', 'MINKBLANKET', 'MINKBELOVED', 'MINKVIPER',
        'MINKSHILOH', 'MINKHEARTBEAT'
    ]

    high_white = [
        'ANY', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO', 'PRINCE', 'FAROFA', 'MISTER', 'PANTS', 'REVERSEPANTS',
        'PIEBALD', 'CURVED', 'MAO', 'PAINTED', 'NIGHTMIST', 'FALCON', 'RETSUKO', 'SNOWSTORM', 'OWL', 'BUB', 'SPARROW',
        'TRIXIE', 'FRONT', 'BLOSSOMSTEP', 'COWELEVEN', 'FINN', 'SCAR', 'BUSTER', 'CAKE',

        'UNDERS', 'MOSSY', 'CHANCE', 'VENUS', 'COW', 'TIDAL', 'COWTHREE', 'COWFIVE', 'COWSEVEN', 'COWNINE', 'BATWING',

        # mink's
        'MINKONE', 'MINKDELILAH', 'MINKHALF', 'MINKOREO', 'MINKSWOOP', 'MINKARMTAIL', 'MINKMOTTLED', 'MINKSTREAMSTRIKE',
        'MINKDAUB', 'MINKBRINDLE', 'MINKPAIGE', 'MINKTABBY', 'MINKSPECKLED', 'MINKBENGAL', 'MINKCLASSIC',
        'MINKMACKEREL', 'MINKMARBLED', 'MINKSABER', 'MINKROSETTE', 'MINKMASKED', 'MINKDUST', 'MINKMAXIMUMSIX',
        'MINKFRECKLED'
    ]

    mostly_white = [
        'VAN', 'ONEEAR', 'LIGHTSONG', 'TAIL', 'HEART', 'MOORISH', 'APRON', 'CAPSADDLE', 'CHESTSPECK', 'BLACKSTAR',
        'PETAL', 'HEARTTWO', 'MOTH', 'FRECKLEMASK', 'DIAMOND', 'ECLIPSE', 'PEBBLESHINE', 'BOOTS', 'COWTEN', 'LOVEBUG',
        'SHOOTINGSTAR', 'EYESPOT', 'PEBBLE', 'TAILTWO', 'BUDDY', 'KROPKA', 'SMALLPATCHES',

        'ANYTWO', 'BROKEN', 'GOATEE', 'HALFWHITE', 'GLASS', 'MASKMANTLE', 'PEPPER', 'SAMMY',

        # mink's
        'MINKBANDANA', 'MINKBODY', 'MINKMAXIMUMONE', 'MINKMAXIMUMTWO', 'MINKMAXIMUMTHREE', 'MINKMAXIMUMFOUR',
        'MINKMAXIMUMFIVE'
    ]
    ...
    vit = [
        'VITILIGO', 'VITILIGOTWO', 'MOON', 'PHANTOM', 'KARPATI', 'POWDER', 'SPLAT', 'BLEACHED', 'SMOKEY',
    ...
    def init_eyes(self, parents):
        ...
        if hit == 0:
            if self.eye_colour in Pelt.yellow_eyes:
                corrected_yellow = Pelt.yellow_eyes.copy()
                corrected_yellow.remove(self.eye_colour)
                ...
                corrected_blue = Pelt.blue_eyes.copy()
                corrected_blue.remove(self.eye_colour)

                eye_choice = choice([
                    Pelt.yellow_eyes, Pelt.yellow_eyes, Pelt.yellow_eyes,
                    corrected_blue,
                    Pelt.green_eyes, Pelt.green_eyes, Pelt.green_eyes,
                    Pelt.red_eyes, Pelt.red_eyes,
                    Pelt.grey_eyes, Pelt.grey_eyes, Pelt.grey_eyes,
                    Pelt.purple_eyes, Pelt.purple_eyes
                ])
                self.eye_colour2 = choice(eye_choice)

            elif self.eye_colour in Pelt.green_eyes:
                corrected_green = Pelt.green_eyes.copy()
                corrected_green.remove(self.eye_colour)
                ...
                corrected_red = Pelt.red_eyes.copy()
                corrected_red.remove(self.eye_colour)
                ...
                corrected_grey = Pelt.grey_eyes.copy()
                corrected_grey.remove(self.eye_colour)
                ...
                corrected_purple = Pelt.purple_eyes.copy()
                corrected_purple.remove(self.eye_colour)
        ...
        if self.name in Pelt.torties:
            ...
            if self.colour:
                ...
                if not wildcard_chance or random.getrandbits(wildcard_chance) == 1:
                    ...
                    if self.tortiepattern == self.tortiebase and self.tortiecolour == self.colour:
                    ...
                    print("You got a wildcard tortie!")
                    if len(self.pattern) == 1:
                        print("Pattern: " + "".join(self.pattern))
                    else:
                        print("Patterns: " + ", ".join(self.pattern))
                    print("Base color: " + self.colour)
                    print("Tortie color: " + self.tortiecolour)
                    print("Base pattern: " + self.tortiebase)
                    print("Tortie pattern: " + self.tortiepattern)
                    ...
                    if (  # non-dilute black
                            ...
                            or self.colour in Pelt.coolbrown_colours
    ...
    def randomize_white_patches(self):
        ...
        if not random.getrandbits(game.config["cat_generation"]["random_point_chance"]):
            # Cat has colorpoint!
            self.points = choice(Pelt.point_markings)
        else:
            self.points = None
    ...
    def describe_appearance(cat, short=False):
        ...
        renamed_colors = {
            ...
            "sienna": "sienna",
            "granite": "granite",
            "blue gray": "bluish-gray",
            "sandstone": "sandstone-colored"
        }
