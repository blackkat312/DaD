...
class Pelt:
    ...
    tortiepatterns = [
        ...
        'MINKMAO', 'MINKWINGS', 'MINKPAINTED', 'MINKHEARTTWO', 'MINKWOODPECKER', 'MINKBOOTS', 'MINKMISS', 'MINKCOW',
        'MINKCOWTWO', 'MINKBUB', 'MINKBOWTIE', 'MINKREVERSEHEART', 'MINKSPARROW', 'MINKVEST', 'MINKLOVEBUG',
        'MINKTRIXIE', 'MINKSAMMY', 'MINKSHOOTINGSTAR', 'MINKREVERSEEYE', 'MINKFRONT', 'MINKBLOSSOMSTEP', 'MINKPEBBLE',
        'MINKTAILTWO', 'MINKBUDDY', 'MINKBULLSEYE', 'MINKFINN', 'MINKDIGIT', 'MINKKROPKA', 'MINKFCONE', 'MINKMIA',
        'MINKSCAR', 'MINKBUSTER', 'MINKHAWKBLAZE', 'MINKCAKE', 'MINKPRINCESS', 'MINKDOUGIE', 'MINKEXTRA'
    ]
