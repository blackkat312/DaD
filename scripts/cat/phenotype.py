...
class Phenotype():
    ...
    def ChooseTortiePattern(self, spec=None):
        tortie_patterns = [
            ...
            'MINKGLASS', 'MINKMOORISH', 'MINKMAO', 'MINKWINGS', 'MINKPAINTED', 'MINKWOODPECKER',
        ...
        if self.genotype.pointgene[0] == "c":
            ...
            if self.genotype.tortiepattern is not None:
                ...
                medlist = [
                    ...
                    'MINKHAWKBLAZE', 'MINKTOPCOVER', 'MINKANY', 'MINKSHIBAINU', 'MINKMISTER', 'MINKTRIXIE', 'MINKWINGS',
                    'MINKMAO', 'MINKMASKMANTLE', 'MINKBUB', 'MINKBULLSEYE', 'MINKSCAR'
                ]
                highlist = [
                    ...
                    'MINKCAKE', 'MINKVAN', 'MINKLIGHTSONG', 'MINKCURVED', 'MINKFINN', 'MINKTAIL', 'MINKAPRON',
                    'MINKHALFWHITE', 'MINKAPPALOOSA', 'MINKHEART', 'MINKMOORISH', 'MINKCOW', 'MINKSHOOTINGSTAR',
                    'MINKTAILTWO', 'MINKBUDDY', 'MINKKROPKA', 'MINKBLACKSTAR', 'MINKPETAL', 'MINKBOOTS'
                ]
                mink = False
                patterntype = "error"
        ...
        if special=='er':
            ...
            if ('masked' in self.silvergold and genes.wbsum > 15) or (genes.agouti[0] != "a" and genes.ext[0] != "Eg") or (genes.ext[0] not in ['Eg', 'E']):
                if genes.silver[0] == "I" or genes.brindledbi or (moons < 3 and genes.karp[0] == "K"):
                    ...
                    elif genes.corin[0] == "sh" or genes.corin[0] == "fg" or genes.ext[0] == 'ec' or (genes.ext[0] == 'ea' and moons > 3):
        ...
        if colour == "apricot":
            if genes.ruftype == "low" or special=='low':
                if genes.silver[0] == "I" and special != 'nosilver' or (moons < 3 and genes.karp[0] == "K"):
                    ...
                    elif genes.corin[0] == "sh" or genes.corin[0] == "fg":
