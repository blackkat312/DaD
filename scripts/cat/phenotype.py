...
class Phenotype():
    ...
    def ChooseTortiePattern(self, spec = None):
        """This is just so that it doesn't think the basegame code is documentation"""
            ...
            for i in range(choice([1, 1, 1, 1, 1, 2, 2, 3])):
                ...
                if randint(1, 15) == 1 or (i > 0 and randint(1, 10) == 1):
                    tortie_low_patterns = ["BOWTIE", "BROKENBLAZE", "BUZZARDFANG", "revCOWTWO", "FADEBELLY", "FADESPOTS", "revLOVEBUG", "MITAINE", 
                                        ...
                                        choice(tiny_patches)]
                    tortie_mid_patterns = ["revAPPALOOSA", "BLOSSOMSTEP", "BOWTIE", "revBROKEN", "revBUB", "revBUSTER", "BUZZARDFANG",
                                        "revCOW", "revCOWTWO", "DAMIEN", "DAPPLEPAW", "DIVA", "FCTWO", "revFINN", "FRECKLES", "revGLASS",
                    ...
                    tortie_high_patterns = ["revANY", "revANYTWO", "BLOSSOMSTEP", "revBUB", "revBUDDY", "revBUSTER", "revCAKE", "revCOW", "revCURVED",
                                        "DAPPLEPAW", "FCTWO", "FAROFA", "revGOATEE", "revHALFFACE", "LILTWO", "MISS", "MISTER", "revMOORISH", 
        ...
        tortie_patterns = [
            ...
            'MINKSAMMY', 'MINKSHOOTINGSTAR', 'MINKREVERSEEYE', 'MINKFRONT', 'MINKBLOSSOMSTEP', 'MINKPEBBLE',
            'MINKTAILTWO', 'MINKBUDDY', 'MINKFINN', 'MINKDIGIT', 'MINKKROPKA', 'MINKFCONE', 'MINKMIA', 'MINKSCAR',
