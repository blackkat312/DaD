...
class ChooseMateScreen(Screens):
    ...
    def update_selected_cat(self):
        ...
        if (
            ...
            and 'sterility' not in self.the_cat.permanent_condition and 'sterility' not in self.selected_cat.permanent_condition
        ):
    ...
    def get_valid_mates(self):
        ...
        valid_mates = [
            ...
            and (
                ...
                or 'sterility' in i.permanent_condition
                or 'sterility' in self.the_cat.permanent_condition
            )
        ]
