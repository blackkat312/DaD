...
class ChangeCatToggles(UIWindow):
    ...
    def refresh_checkboxes(self):
        ...
        if self.the_cat == game.clan.instructor:
            ...
            box_type = "@checked_checkbox"
            tool_tip = "windows.allow_fading_tooltip"
        else:
        ...
        # No Kits
        if "sterility" in self.the_cat.permanent_condition:
            if self.the_cat.no_kits:
                box_type = "@checked_checkbox"
                tool_tip = "windows.allow_adoption_tooltip"
            else:
                box_type = "@unchecked_checkbox"
                tool_tip = "windows.prevent_adoption_tooltip"
        else:
            if self.the_cat.no_kits:
                box_type = "@checked_checkbox"
                tool_tip = "windows.allow_kits_tooltip"
            else:
                box_type = "@unchecked_checkbox"
                tool_tip = "windows.prevent_kits_tooltip"
        ...
        self.checkboxes["prevent_mates"] = UIImageButton(
            ...
            tool_tip_text="windows.prevent_romance_tooltip_yes"
            if self.the_cat.no_mates
            else "windows.prevent_romance_tooltip_no",
        )
