...
class Condition_Events:
        ...
        for illness in illnesses:
            ...
            if cat.dead or (
                ...
                try:
                    ...
                    print(
                        f"WARNING: {illness} does not have an illness death string, placeholder used."
                    )
    ...
    def handle_already_disabled(cat):
        ...
        condition_progression = {
            ...
            "failing eyesight in one eye" : "one bad eye"
        }
        ...
        for condition in conditions:
            ...
            if status == 'reveal' and condition not in ['sterility', 'manx syndrome']:
        ...
        for risk in conditions[condition]["risks"]:
            ...
            if (
                ...
                try:
                    ...
                    event = event.replace("CONDITIONRISK", str(new_condition_name))
                    event = event.replace("OGCONDITION", str(condition))
